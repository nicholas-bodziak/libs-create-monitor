  ...
  return <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container py-12">
          ...
          <section aria-labelledby="techs" className="mt-12 mx-auto max-w-5xl text-center">
            <h2 id="techs" className="text-2xl font-semibold tracking-tight">Tecnologias e Frameworks suportados</h2>
            <p className="mt-1 text-sm text-muted-foreground">Selecione a ferramenta ideal de acordo com seu stack.</p>
            <div className="mt-6 grid gap-6 md:grid-cols-3 group isolate">
              <article className="transition-opacity group-hover:opacity-80 hover:opacity-100">
                <Card className="h-full relative transform-gpu transition-all duration-200 ease-out will-change-transform ring-1 ring-border/50 hover:scale-[1.03] hover:-translate-y-1 hover:shadow-xl hover:ring-ring/30 hover:z-10">
                  <CardHeader className="items-center">
                    <img loading="lazy" width={40} height={40} alt="Datadog logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/datadog/datadog-original.svg" />
                    <CardTitle className="mt-2">Datadog</CardTitle>
                  </CardHeader>
                  <CardContent className="text-left">
                    <ul className="list-none text-sm text-muted-foreground space-y-2">
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="Kubernetes logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kubernetes/kubernetes-plain.svg" />
                        <span>Kubernetes</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="Node.js logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-plain.svg" />
                        <span>Node.js</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="Java logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-plain.svg" />
                        <span>Java</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="PostgreSQL logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-plain.svg" />
                        <span>PostgreSQL</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="NGINX logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nginx/nginx-original.svg" />
                        <span>NGINX</span>
                      </li>
                    </ul>
                  </CardContent>
              ...
              <article className="transition-opacity group-hover:opacity-80 hover:opacity-100">
                <Card className="h-full relative transform-gpu transition-all duration-200 ease-out will-change-transform ring-1 ring-border/50 hover:scale-[1.03] hover:-translate-y-1 hover:shadow-xl hover:ring-ring/30 hover:z-10">
                  ...
                  <CardContent className="text-left">
                    <ul className="list-none text-sm text-muted-foreground space-y-2">
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="Linux logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg" />
                        <span>Linux</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="Windows logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/windows8/windows8-original.svg" />
                        <span>Windows</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="MySQL logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" />
                        <span>MySQL</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="NGINX logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nginx/nginx-original.svg" />
                      ...
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="Docker logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg" />
                        <span>Docker</span>
                      </li>
                    </ul>
                  </CardContent>
              ...
              <article className="transition-opacity group-hover:opacity-80 hover:opacity-100">
                <Card className="h-full relative transform-gpu transition-all duration-200 ease-out will-change-transform ring-1 ring-border/50 hover:scale-[1.03] hover:-translate-y-1 hover:shadow-xl hover:ring-ring/30 hover:z-10">
                  <CardHeader className="items-center">
                    <img loading="lazy" width={40} height={40} alt="Dynatrace logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dynatrace/dynatrace-original.svg" />
                    <CardTitle className="mt-2">Dynatrace</CardTitle>
                  </CardHeader>
                  <CardContent className="text-left">
                    <ul className="list-none text-sm text-muted-foreground space-y-2">
                      ...
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt="AWS logo" src={awsLogo} />
                        <span>AWS Lambda</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <img loading="lazy" width={20} height={20} alt=".NET logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dotnetcore/dotnetcore-plain.svg" />
                        <span>.NET</span>
                      </li>
                    </ul>
                  </CardContent>
